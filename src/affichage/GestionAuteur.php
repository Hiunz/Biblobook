  ...
  <main id="main" style="margin-top: 100px;">
    ...
    <section style="display: flex;align-items: center;flex-direction: column;padding: 40px;" id="searsh" class="contact">
        <header class="section-header">
              <h2>Gestion d'auteurs</h2>
              <p>Gérez des auteurs</p>
            </header>
        ...
        <div class="hero-callout">
            <div id="example_wrapper" class="dataTables_wrapper">
                <table id="example" class="display nowrap dataTable dtr-inline collapsed" style="width: 100%;border: solid;margin-bottom: 10px;border-color: #b9b9b9;" aria-describedby="example_info">
                    <thead>
                        <tr>
                            <th class="sorting sorting_asc" style="width: 102px; text-align: center;" aria-sort="ascending" aria-label="Nom de l'auteur">Nom</th>
                            <th class="sorting" style="width: 168px; text-align: center;" aria-label="Prenom de l'auteur">Prenom</th>
                            <th class="sorting" style="width: 70px; text-align: center;" aria-label="Date de naissance de l'auteur">Naissance</th>
                            <th class="sorting" style="width: 75px; text-align: center;" aria-label="Pays">Pays</th>
                    ...
                    <tbody>
                        ...
                        <tr class="<?= ($increment%2 == 1)?"odd":"even" ?> parent">
                            <td class="sorting_1  dtr-control"><?= $auteur->getNom() ?></td>
                            <td><?= $auteur->getAuteur()->getPrenom() ?></td>
                            <td><?= $auteur->getDate_de_naissance() ?></td>
                            <td><?= $auteur->getPays() ?></td>

                            <?php
                            if (!empty($_SESSION['user'])) {?>
                              <td class="selectRow">
                                  <form action="../traitement/GestionAuteur.php" method="Post">
                                      <input type="hidden" name="auteurSelect" value="<?= $auteur->getId() ?>">
